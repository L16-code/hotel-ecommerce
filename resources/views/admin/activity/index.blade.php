        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    ...
                    <form action="{{ route('activities.save') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <span class="la la-user form-icon"></span>
                                                <input class="form-control" type="text" name="min_age"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-box">
                                            ...
                                            <div class="form-group">
                                                <span class="la la-envelope-o form-icon"></span>
                                                <input class="form-control" type="text" name="inquiry_email"
