                    ...
                    <div class="filter-wrap margin-bottom-30px">
                        <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                            ...
                            <div class="layout-view d-flex align-items-center">
                                <a href="tour-grid.html" data-toggle="tooltip" data-placement="top" title="Grid View"><i
                                        class="la la-th-large"></i></a>
                                <a href="tour-list.html" data-toggle="tooltip" data-placement="top" title="List View"
            ...
            <div class="row">
                    ...
                    <div class="sidebar mt-0">
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="sidebar-category">
                                ...
                                <div class="custom-checkbox">
                                    ...
                                    <label for="c2">Active Adventure Tours <span
                                            class="font-size-13 ml-1">(809)</span></label>
                                </div>
                                <div class="custom-checkbox">
                                ...
                                <div class="custom-checkbox">
                                    ...
                                    <label for="c4">Escorted Tours <span
                                            class="font-size-13 ml-1">(401)</span></label>
                                </div>
                                <div class="custom-checkbox">
                                ...
                                <div class="collapse" id="categoryMenu">
                                    <div class="custom-checkbox">
                                        ...
                                        <label for="c7">Family Tours <span
                                                class="font-size-13 ml-1">(100)</span></label>
                                    </div>
                                    <div class="custom-checkbox">
                                        <input type="checkbox" id="c8">
                                        <label for="c8">City Trips <span
                                                class="font-size-13 ml-1">(58)</span></label>
                                    </div>
                                    <div class="custom-checkbox">
                                        <input type="checkbox" id="c9">
                                        <label for="c9">National Parks Tours <span
                                                class="font-size-13 ml-1">(33)</span></label>
                                    </div>
                                </div><!-- end collapse -->
                                <a class="btn-text" data-toggle="collapse" href="#categoryMenu" role="button"
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="sidebar-category">
                                ...
                                <a class="btn-text" data-toggle="collapse" href="#tourDurationMenu" role="button"
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card-item card-item-list ">
                        ...
                        <div class="card-img">
                            <a href="{{route('user.activity.singleactivity',$item->id)}}" class="d-block">
                                <img src="{{asset('uploads/activity/'.$item->file)}}" alt="Destination-img">
                            </a>
                        ...
                        <div class="card-body">
                            <h3 class="card-title"><a href="{{route('user.activity.singleactivity',$item->id)}}">{{$item->name}}</a></h3>
                            <p class="card-meta">{{$item->place_name}}, {{$item->country}}</p>
                            ...
                            <div class="card-price d-flex align-items-center justify-content-between">
                                ...
                                <a href="{{route('user.activity.singleactivity',$item->id)}}" class="btn-text">See details<i
                                    class="la la-angle-right"></i></a>                            </div>
                        </div>
