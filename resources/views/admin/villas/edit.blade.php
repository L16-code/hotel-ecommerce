    ...
    <div class="row">
        <div class="col-lg-9 mx-auto">
            <div class="listing-header pb-4">
                ...
                <p class="font-size-14">If you are listing a vacation rental, please <a href="#" class="text-color">click
                        here.</a></p>
                <p class="font-size-14"><a href="#" class="text-color">Read the complete Trizen policy for
                        accommodations.</a></p>
            </div>
        <form method="post"  action="{{ route('villas.update',$show->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="form-box">
                        ...
                        <div class="col-lg-6 responsive-column">
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name" placeholder="Your name" value="{{$show->name}}">
                                </div>
                            </div>
                        </div><!-- end col-lg-6 -->
                        <div class="col-lg-6 responsive-column">
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" name="email" placeholder="Your email" value="{{$show->email}}">
                                </div>
                            </div>
                        </div><!-- end col-lg-6 -->
                        <div class="col-lg-6 responsive-column">
            ...
            <div class="form-box">
                <div class="form-title-wrap">
                    <h3 class="title"><i class="la la-gear mr-2 text-gray"></i>Listing information for your accommodation
                    </h3>
                </div><!-- form-title-wrap -->
                <div class="form-content contact-form-action">
                    <div class="row">
                    <div class="col-lg-6 responsive-column">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="business_name" placeholder="Business name" value="{{$show->business_name}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6 responsive-column">
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="city"
                                    placeholder="example: New York" value="{{$show->city}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6 responsive-column d-flex align-items-center">
                        <div class="input-box">
                            <div class="form-group custom-checkbox pt-4">
                                <input type="checkbox" id="yourCityIsNotListed" name="notlisted" value="1"
                                @if($show->not_listed==1) {{'checked'}} @endif>

                                <label for="yourCityIsNotListed">Your city is not listed</label>
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-4">
                        <div class="input-box">
                            ...
                            <div class="form-group select-contain w-100">
                                <select class="select-contain-select" name="country_code">
                                    <option value="{{$show->country_code}}">{{$show->country_code}}</option>
                    ...
                    <div class="col-lg-8">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="s_address" value="{{$show->s_address}}"
                    ...
                    <div class="col-lg-12">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <span class="la la-map-marker form-icon"></span>
                                <input class="form-control" type="text" name="a_address" value="{{$show->a_address}}"
                ...
                <div class="form-content contact-form-action">
                    ...
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <span class="la la-map form-icon"></span>
                                <input class="form-control" id="longitude" name="longitude" type="text" placeholder="Map Longitude" value="{{$show->longitude}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <span class="la la-map form-icon"></span>
                                <input class="form-control" id="latitude" name="latitude" type="text" placeholder="Map Latitude" value="{{$show->latitude}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-12">
                        <div class="input-box">
                            ...
                            <div class="form-group map-container">
                                <div id="singleMap" name="singlemap"class="drag-map" data-latitude="40.7427837"
                    ...
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="phone" placeholder="+1(1)8547632521" value="{{$show->phone}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text"  name="fax"placeholder="+1(1)1147521433" {{$show->fax}}>
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <span class="la la-envelope-o form-icon"></span>
                                <input class="form-control" type="text" name="inquiry_email" placeholder="Email for customer inquiries" {{$show->inquiry_email}}>
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="website"placeholder="https://www.techydevs.com/" value="{{$show->website}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="facebook" placeholder="https://www.facebook.com/" value="{{$show->facebook}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="instagram" placeholder="https://www.instagram.com/"value="{{$show->instagram}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="twitter" placeholder="https://www.twitter.com/"value="{{$show->twitter}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="linkedin" placeholder="https://www.linkedin.com/"value="{{$show->linkedin}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                </div>
            ...
            <div class="form-box">
                <div class="form-title-wrap">
                    <h3 class="title"><i class="la la-building-o mr-2 text-gray"></i>Information about your accommodation
                    </h3>
                </div><!-- form-title-wrap -->
                <div class="form-content contact-form-action">
                    <div  class="row">
                    <div class="col-lg-12">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="rooms" value="{{$show->total_rooms_suites}}"
                    ...
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group d-flex align-items-center">
                                <input class="form-control pl-3" type="text" name="min" placeholder="Min"value="{{$show->min}}">
                                <span class="px-2">to</span>
                                <input class="form-control pl-3" type="text" name="max" placeholder="Max"value="{{$show->max}}">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group select-contain w-100">
                                <select class="select-contain-select" name="currency">
                                    <option value="value="{{$show->currency}}"">value="{{$show->currency}}"</option>
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="message-control form-control" name="message"
                                    placeholder="In English only, no HTML, no web or email address, no ALL CAPS">value="{{$show->message}}"</textarea>
                            </div>
                        </div>
                    </div><!-- end col-lg-12 -->
                    <div class="col-lg-12">
                        <div class="input-box">
                            ...
                            <p class="font-size-13 mb-3 line-height-20">400 character limit</p>
                            <div class="form-group select-contain w-100">
                                <select class="select-contain-select" name="language">
                                    <option value="value="{{$show->language}}">{{$show->language}}</option>
                            ...
                            <div class="form-group">
                                <span class="la la-pencil form-icon"></span>
                                <textarea class="message-control form-control" name="message"
                                    placeholder="No HTML, no web or email address, no ALL CAPS           "></textarea>
                            </div>
                        </div>
                    </div><!-- end col-lg-12 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group d-flex align-items-center">
                                ...
                                <label for="radio-1" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-1" name=" stay"value="on"
                                    @if($show->stay=='3 nights or less'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>3 nights or less</span>
                                </label>

                                <label for="radio-2" class="radio-trigger mb-0 font-size-14">
                                    <input type="radio" id="radio-2" name="stay" value="on"
                                    @if($show->stay=='More than 3 nights'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group d-flex align-items-center">
                                <label for="radio-3" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-3" name="security"value="on"
                                    @if($show->security=='On site'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>On site</span>
                                </label>
                                <label for="radio-4" class="radio-trigger mb-0 font-size-14">
                                    <input type="radio" id="radio-4" name="security" value="on"
                                    @if($show->security=='None'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>None</span>
                                </label>
                            </div>
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group d-flex align-items-center">
                                <label for="radio-5" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-5" name="staff" value="on"
                                    @if($show->staff=='yes'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>Yes</span>
                                </label>
                                <label for="radio-6" class="radio-trigger mb-0 font-size-14">
                                    <input type="radio" id="radio-6" name="staff" value="on"
                                    @if($show->staff=='no'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>No</span>
                                </label>
                            </div>
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group d-flex align-items-center">
                                <label for="radio-7" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-7" name="housekeeping" value="on"
                                    @if($show->housekeeping=='Included in room rate'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>Included in room rate</span>
                                </label>
                                <label for="radio-8" class="radio-trigger mb-0 font-size-14">
                                    <input type="radio" id="radio-8" name="housekeeping" value="on"
                                    @if($show->housekeeping=='Additional Fee'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group d-flex align-items-center">
                                <label for="radio-9" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-9" name="frequency"value="on"
                                    @if($show->frequency=='Daily'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>Daily</span>
                                </label>
                                <label for="radio-10" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-10" name="frequency"value="on"
                                    @if($show->frequency=='Weekly'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>Weekly</span>
                                </label>
                                <label for="radio-11" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-11" name="frequency"value="on"
                                    @if($show->frequency=='Bi-weekly'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>Bi-weekly</span>
                                </label>
                                <label for="radio-12" class="radio-trigger mb-0 font-size-14">
                                    <input type="radio" id="radio-12" name="frequency"value="on"
                                    @if($show->frequency=='None'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>None</span>
                                </label>
                            </div>
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group d-flex align-items-center">
                                <label for="radio-13" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-13" name="front_desk"value="on"
                                    @if($show->front_desk=='24-hour staffing'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>24-hour staffing</span>
                                </label>
                                <label for="radio-14" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-14" name="front_desk"value="on"
                                    @if($show->front_desk=='Limited hours staffing'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>Limited hours staffing</span>
                                </label>
                                <label for="radio-15" class="radio-trigger mb-0 font-size-14">
                                    <input type="radio" id="radio-15" name="front_desk"value="on"
                                    @if($show->front_desk=='None'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>None</span>
                                </label>
                            </div>
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group d-flex align-items-center">
                                <label for="radio-16" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-16" name="bathroom"value="on"
                                    @if($show->bathroom=='All en suite'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>All en suite</span>
                                </label>
                                <label for="radio-17" class="radio-trigger mb-0 font-size-14 mr-3">
                                    <input type="radio" id="radio-17" name="bathroom"value="on"
                                    @if($show->bathroom=='Some en suite'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>Some en suite</span>
                                </label>
                                <label for="radio-18" class="radio-trigger mb-0 font-size-14">
                                    <input type="radio" id="radio-18" name="bathroom"value="on"
                                    @if($show->bathroom=='Shared'){{'checked'}} @endif>
                                    <span class="checkmark"></span>
                                    <span>Shared</span>
                                </label>
                            </div>
                ...
                <div class="form-content contact-form-action">
                    ...
                    <div class="col-lg-6">
                        <div class="custom-checkbox">
                            <input type="checkbox" id="AirportTransportation" value="Airport Transportation" name="amenities[]">
                            <label for="AirportTransportation">Airport Transportation</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="BarLounge" value="Bar / Lounge" name="amenities[]">
                            <label for="BarLounge">Bar / Lounge</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="Beach" value="Beach" name="amenities[]">
                            <label for="Beach">Beach</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="BeverageSelection" value="Beverage Selection" name="amenities[]">
                            <label for="BeverageSelection">Beverage Selection</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="SwimmingPool"value="Swimming Pool" name="amenities[]">
                            <label for="SwimmingPool">Swimming Pool</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="WIFI" value="WI-FI" name="amenities[]">
                            <label for="WIFI">WI-FI</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="Coffee" value="Coffee" name="amenities[]">
                            <label for="Coffee">Coffee</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="AirConditioning"value="Air Conditioning" name="amenities[]">
                            <label for="AirConditioning">Air Conditioning</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="Entertainment" value="Entertainment" name="amenities[]">
                            <label for="Entertainment">Entertainment</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="ElevatorInBuilding" value="Elevator In Building" name="amenities[]">
                            <label for="ElevatorInBuilding">Elevator In Building</label>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="custom-checkbox">
                            <input type="checkbox" id="WheelchairAccess" value="Wheelchair access" name="amenities[]">
                            <label for="WheelchairAccess">Wheelchair access</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="FitnessFacility" value="Fitness Facility" name="amenities[]">
                            <label for="FitnessFacility">Fitness Facility</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="Breakfast" value="Breakfast" name="amenities[]">
                            <label for="Breakfast">Breakfast</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="HandicapAccessible"value="Handicap Accessible" name="amenities[]">
                            <label for="HandicapAccessible">Handicap Accessible</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="PetsAllowed" value="Pets Allowed" name="amenities[]">
                            <label for="PetsAllowed">Pets Allowed</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="SuitableForEvents" value="Suitable For Events" name="amenities[]">
                            <label for="SuitableForEvents">Suitable For Events</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="Restaurant" name="amenities[]">
                            <label for="Restaurant">Restaurant</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="Doorman" value="Doorman" name="amenities[]">
                        ...
                        <div class="custom-checkbox">
                            <input type="checkbox" id="WineBar" value="Wine Bar" name="amenities[]">
            ...
            <div class="form-box">
                <div class="form-title-wrap">
                    <h3 class="title"><i class="la la-photo mr-2 text-gray"></i>Choose a photo to represent this
                        listing</h3>
                </div><!-- form-title-wrap -->
                <div class="form-content contact-form-action">
                    ...
                    <div class="col-lg-12">
                        <div class="file-upload-wrap">
                            <input type="file" name="files[]" class="multi file-upload-input with-preview" multiple
                                maxlength="3">
                            <span class="file-upload-text"><i class="la la-upload mr-2"></i>Click or drag images
                                here to upload</span>
                        </div>
                    </div><!-- end col-lg-12 -->
            ...
            <div class="submit-box">
                ...
                <div class="custom-checkbox">
                    ...
                    <label for="agreeChb">Check this box to certify that you are an official representative of the
                        property for which you are submitting this listing and that the information you have submitted is
                        correct. In submitting a photo, you also certify that you have the right to use the photo on the web
                        and agree to hold Trizen harmless for any and all copyright issues arising from your use of the
                        image.</label>
                </div>
