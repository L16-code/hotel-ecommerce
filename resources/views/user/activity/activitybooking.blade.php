                    ...
                    <div class="form-box">
                        ...
                        <div class="form-content ">
                            <div class="contact-form-action">
                                <form action="{{route('user.activity.book.save',$activity_book->id)}}" method="post">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="input-box">
                                                <div class="custom-checkbox mb-0">
                                                    ...
                                                    <label for="receiveChb">I want to receive Trizen promotional offers in
                                                        the future</label>
                                                </div>
                                            </div>
                                        </div><!-- end col-lg-12 -->
                            ...
                            <div class="card-item shadow-none radius-none mb-0">
                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <a href="hotel-single.html" class="btn ml-1"><i class="la la-edit"
                                    ...
                                    <ul class="list-items list-items-2 py-2">
                                        <li><span>Check in-Check out:</span>{{$data[1]}}</li>
                                        {{-- <li><span></span>12 Jun 2020 at 2:10 pm</li> --}}
                                    </ul>
                                    <div class="section-block"></div>
                                    <h3 class="card-title pt-3 pb-2 font-size-15"><a href="hotel-single.html">Order
                                            Details</a></h3>
                                    <div class="section-block"></div>
                                    <ul class="list-items list-items-2 py-3">
                                        <li><span>Room Type:</span>Standard family</li>
                                        <li><span>Room:</span>{{$data[2]}}Rooms</li>
                                        <li><span>Per Room Price:</span>$121</li>
                                        <li><span>Adults:</span>{{$data[4]}}</li>
