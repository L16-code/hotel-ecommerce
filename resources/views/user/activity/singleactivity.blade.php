                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb-btn">
                            <div class="btn-box">
                                ...
                                <a class="theme-btn" data-src="images/destination-img.jpg" data-fancybox="gallery"
                            ...
                            <div id="description" class="page-scroll">
                                <div class="single-content-item pb-4">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center pt-2">
                                        <p class="mr-2">{{$data->place_name}}, {{$data->country}}</p>
                                        <p>
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    ...
                                                    <span class="font-size-13">{{$data->duration}}</span>
                                                </div>
                                        ...
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    ...
                                                    <span class="font-size-13">{{$data->group_size}}</span>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    ...
                                                    <span class="font-size-13">{{$data->tour_type}}</span>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    ...
                                                    <span class="font-size-13">{{$data->date}}</span>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">Min Age</h3>
                                                    <span class="font-size-13">{{$data->age}}</span>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                        <div class="col-lg-4 responsive-column">
                                            <div class="single-tour-feature d-flex align-items-center mb-3">
                                                ...
                                                <div class="single-feature-titles">
                                                    <h3 class="title font-size-15 font-weight-medium">Pickup From</h3>
                                                    <span class="font-size-13">{{$data->pickup}}</span>
                                                </div>
                                            </div><!-- end single-tour-feature -->
                                        </div><!-- end col-lg-4 -->
                                    </div><!-- end row -->
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 responsive-column">
                                            <ul class="list-items pb-3">
                                                <li><i class="la la-dot-circle text-color mr-2"></i>Dolorem mediocritatem
                                                </li>
                                        ...
                                        <div class="col-lg-6 responsive-column">
                                            <ul class="list-items pb-3">
                                                ...
                                                <li><i class="la la-dot-circle text-color mr-2"></i>Oportere democritum
                                                </li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 responsive-column">
                                            ...
                                            <ul class="list-items">
                                                ...
                                                <li><i class="la la-check text-success mr-2"></i>Tour Guide</li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-6 responsive-column">
                                            <h3 class="title font-size-15 font-weight-medium pb-3">Not Included</h3>
                                            <ul class="list-items">
                                                <li><i class="la la-times text-danger mr-2"></i>Entrance Fees</li>
                                                <li><i class="la la-times text-danger mr-2"></i>Guide Gratuity</li>
                                            ...
                                            <div class="card-header" id="faqHeadingFour">
                                                <h2 class="mb-0">
                                                    <button
                                                        ...
                                                        <span class="ml-3">I'm a solo traveller, is there a single
                                                            supplement?</span>
                                            ...
                                            <div class="card-header" id="faqHeadingFive">
                                                <h2 class="mb-0">
                                                    <button
                                                        ...
                                                        <span class="ml-3">Should I book pre/post tour
                                                            accommodation?</span>
                                                        <i class="la la-minus"></i>
                                                        <i class="la la-plus"></i>
                                                    </button>
                                            ...
                                            <div class="card-header" id="faqHeadingSix">
                                                <h2 class="mb-0">
                                                    <button
                                                        ...
                                                        <span class="ml-3">What is cancellation policy?</span>
                                                        <i class="la la-minus"></i>
                                                        <i class="la la-plus"></i>
                                                    </button>
                                                </h2>
                                            ...
                                            <div class="card-header" id="faqHeadingSeven">
                                                <h2 class="mb-0">
                                                    <button
                                                        ...
                                                        <span class="ml-3">Which currency is most widely accepted on this
                                                            tour?</span>
                                                        <i class="la la-minus"></i>
                                                        <i class="la la-plus"></i>
                                                    </button>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar single-content-sidebar mb-0">
                            <div class="sidebar-widget single-content-widget">
                                ...
                                <form action="{{route('user.activity.data',$data->id)}}">
                                    @csrf
                                    <div class="sidebar-widget-item">
                                        <div class="contact-form-action">
                                    ...
                                    <div class="btn-box pt-2">
                                        <button  class="theme-btn text-center w-100 mb-2"><i
                                                class="la la-shopping-cart mr-2 font-size-18"data-toggle="modal" data-target="#signupPopupForm"></i>Book Now</button>
                                ...
                                <div class="btn-box pt-2">
                                    <a href="tour-booking.html" class="theme-btn text-center w-100 mb-2"><i
                                            class="la la-shopping-cart mr-2 font-size-18"></i>Book Now</a>
                                    <a href="#" class="theme-btn text-center w-100 theme-btn-transparent"><i
                                            class="la la-heart-o mr-2"></i>Add to Wishlist</a>
                                    <div class="d-flex align-items-center justify-content-between pt-2">
                                        <a href="#" class="btn theme-btn-hover-gray font-size-15"
                                                    ...
                                                    <div class="input-box">
                                                        <div class="form-group">
                                                            <div class="custom-checkbox mb-0">
                                                                ...
                                                                <label for="agreeChb">I agree with <a href="#">Terms
                                                                        of Service</a> and
                                ...
                                <div class="author-content d-flex">
                                    ...
                                    <div class="author-bio">
                                        ...
                                        <div class="btn-box pt-3">
                                            <a href="#" class="theme-btn theme-btn-small theme-btn-transparent">Ask
                                                a Question</a>
                                        </div>
                                    </div>
                                </div>
