            ...
            <div class="sidebar-menu-wrap">
                <ul class="sidebar-menu list-items">
                    ...
                    <li><a href="user-dashboard-booking.html"><i class="la la-shopping-cart mr-2 text-color-2"></i>My
                            Booking</a></li>
                    <li><a href="{{route('user.dashboard.profile')}}"><i class="la la-user mr-2 text-color-3"></i>My Profile</a>
                    </li>
                    <li><a href="user-dashboard-reviews.html"><i class="la la-star mr-2 text-color-4"></i>My Reviews</a>
                    </li>
                    <li><a href="user-dashboard-wishlist.html"><i class="la la-heart mr-2 text-color-5"></i>Wishlist</a>
                    </li>
                    <li class="page-active"><a href="user-dashboard-settings.html"><i
                                class="la la-cog mr-2"></i>Settings</a></li>
                    ...
                    <div class="row">
                                ...
                                <div class="form-content">
                                    <div class="user-profile-action d-flex align-items-center pb-4">
                                        ...
                                        <div class="upload-btn-box">
                                            <p class="pb-2 font-size-15 line-height-24">Max file size is 5MB, Minimum
                                                dimension: 150x150 And Suitable files are .jpg &amp; .png</p>
                                    ...
                                    <div class="contact-form-action">
                                        <form action="{{route('user.dashboard.profile.edit')}}" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-6 responsive-column">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" name="name"type="text" value="{{$data->username}}">
                                                        </div>
                                                    </div>
                                                </div><!-- end col-lg-6 -->
                                                {{-- <div class="col-lg-6 responsive-column">
                        ...
                        <div class="col-lg-6">
                            <div class="form-box">
                                ...
                                <div class="form-content">
                                    <div class="contact-form-action">
                                        <form action="{{route('user.dashboard.password.edit')}}" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-6 responsive-column">
                                                    <div class="input-box">
                        ...
                        {{-- <div class="col-lg-6">
                            <div class="form-box">
                                <div class="form-title-wrap">
                                    ...
                                    <p class="font-size-15 line-height-24">Enter the email of your account to reset
                                        password. Then you will receive a link to email
                                        <br> to reset the password.If you have any issue about reset password <a
                                            href="contact.html" class="color-text">contact us</a>
                                    </p>
                                </div>
                                <div class="form-content">
                                    <div class="contact-form-action">
