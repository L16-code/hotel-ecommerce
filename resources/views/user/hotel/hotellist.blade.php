                    ...
                    <div class="filter-wrap margin-bottom-30px">
                        <div class="filter-top d-flex align-items-center justify-content-between pb-4">
                            <div>
                                ...
                                <p class="font-size-14"><span class="mr-1 pt-1">Book with confidence:</span>No hotel booking
                                    fees</p>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card-item card-item-list">
                        <div class="card-img">
                            <a href="{{route('user.hotel.singlehotel',$item->id)}}" class="d-block">
                                <img src="{{asset('uploads/hotel/'.$item->files)}}" alt="hotel-img">
                            </a>
                        ...
                        <div class="card-body">
                            <h3 class="card-title"><a href="{{route('user.hotel.singlehotel',$item->id)}}">{{$item->name}}</a></h3>
                            <p class="card-meta">{{$item->s_address}} ,{{$item->country}}</p>
                            ...
                            <div class="card-price d-flex align-items-center justify-content-between">
                                <p>
                                    ...
                                    <span class="price__num">{{$item->min}}</span>
                                    <span class="price__text">Per night</span>
                                </p>
                                <a href="{{route('user.hotel.singlehotel',$item->id)}}" class="btn-text">See details<i
