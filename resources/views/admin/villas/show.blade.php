                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30 text-white">villas Application</h2>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-box">
                            <div class="form-title-wrap">
                                <h3 class="title">villas Application Lists</h3>
                                {{-- <p class="font-size-14">Showing 1 to 8 of 20 entries</p> --}}

                            </div>
                            <div class="row">
                                <div class="col-lg-4 align-centre" >
                                    <a type="button" href="{{ route('villas') }}" class="btn btn-primary">Add</a>
                                </div>
                                <div class="col-lg-4 ">
                                    <form  action="{{ route('villas.show') }}" method="GET"
                                        ...
                                        <div class="input-group ">
                                            ...
                                            {{-- <button value="{{ request('search') }} class="search-btn"><i class="la la-search"></i></button> --}}
                                        ...
                                        <tbody>
                                            @foreach ($data as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-content">
                                                            <a href="{{ route('villas.view', $item->id) }}" class="theme-btn theme-btn-small mr-2"
                                                                data-toggle="tooltip" data-placement="top" title="View"><i
                                                                    class="la la-eye"></i></a>
                                                            <a href="{{ route('villas.edit', $item->id) }}"
                                                                class="theme-btn theme-btn-small" data-toggle="tooltip"
                                                                data-placement="top" title="Edit"><i
                                                                    class="la la-edit"></i></a>
                                                            <a href="{{ route('villas.delete', $item->id) }}"
                                                                class="theme-btn theme-btn-small" data-toggle="tooltip"
