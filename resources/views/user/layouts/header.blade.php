                    ...
                    <div class="menu-wrapper">
                        ...
                        <div class="main-menu-content">
                            <nav>
                                <ul>
                                    <li>
                                        <a href="{{route('user.home')}}">Home <i class="la la-angle"></i></a>
                                    ...
                                    <li>
                                        <a href="{{route('user.activity.list')}}">Activity <i class="la la-angle"></i></a>
                                        {{-- <ul class="dropdown-menu-item">
                                    ...
                                    <li>
                                        <a href="{{route('user.hotel.list')}}">Hotel <i class="la la-angle"></i></a>
                                        {{-- <ul class="dropdown-menu-item">
                                ...
                                @endif</label> --}}
                                    ...
                                    {{-- <li>
                                        ...
                                        <ul class="dropdown-menu-item">
                                            ...
                                            <li><a href="{{route('user.hotel.list')}}">Hotel list</a></li>
                                    ...
                                    @if(Auth::check())
                                    <li>
                                        <a href="{{route('user.profile')}}">My Dashboard</a>
                                        {{-- <ul class="dropdown-menu-item">
                                            <li><a class="theme-btn theme-btn-small" href="{{route('user.profile')}}">My Dashboard</a></li>
                                    ...
                                    @else
                                    <li>
                                    <a href="{{route('user.login')}}" type="button" class="" >Login</a>
                                    </li>
                                    @endif
                                    {{-- <li>
