                ...
                <div class="col-lg-12">
                    <div class="form-box">
                        <div class="form-title-wrap">
                            <h3 class="title">Activity Detail Lists</h3>
                        </div>
                        <div class="form-content">
                            <ul class="list-items list-items-2 list-items-flush">
                                <li><span>Acitvity ID#</span>{{$data->id}}</li>
                                <li><span>Acitvity name:</span>{{$data->name}}</li>
                                <li><span>Acitvity email:</span> {{$data->email}}</li>
                            ...
                            <div class="btn-box mt-4">
                                <a href="{{ route('activities.edit', $data->id) }}" class="theme-btn theme-btn-small" ><i class="la la-Pencil mr-1"></i>Edit</a>
                            </div>
                        </div>
                    </div><!-- end form-box -->
                </div><!-- end col-lg-12 -->
