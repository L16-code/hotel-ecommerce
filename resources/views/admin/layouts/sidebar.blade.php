    ...
    <div class="sidebar-nav-body">
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu toggle-menu list-items">
                <li ><a href="{{route('index')}}"><i class="la la-dashboard mr-2"></i>Dashboard</a></li>
                <li><a href="{{route('admin.booking')}}"><i class="la la-shopping-cart mr-2 text-color"></i>Booking</a></li>
                {{-- <li>
                ...
                <li><a href="{{route('agent')}}"><i class="la la-text-width mr-2 text-color-7"></i>Travel Agents</a></li>
                <li><a href="{{route('villas.show')}}"><i class="la la-text-width mr-2 text-color-7"></i>Villas</a></li>
                <li><a href="{{route('activities.show')}}"><i class="la la-plane mr-2 text-color-7"></i>Activities</a></li>
