                            ...
                            <div class="form-title-wrap">
                                <div class="d-flex align-items-center justify-content-between">
                                    <ul class="chart-pagination d-flex">
                                        ...
                                        <li><a href="#"
                                                class="theme-btn theme-btn-small theme-btn-transparent mr-2">Week</a>
                                        </li>
                                        <li><a href="#" class="theme-btn theme-btn-small theme-btn-transparent">This
                                                year</a></li>
                                    </ul>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 responsive-column-l">
                                        <div
                                            ...
                                            <div class="section-block"></div>
                                            <a href="#"
                                                class="d-flex align-items-center justify-content-between view-all">View
                                                Details <i class="la la-arrow-right"></i></a>
                                        </div>
                                    </div><!-- end col-lg-3 -->
                                    <div class="col-lg-3 responsive-column-l">
                                        <div
