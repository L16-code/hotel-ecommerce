...
@section('content')
    <div class="row">
        ...
        <form method="post"  action="{{ route('villas.save') }}" enctype="multipart/form-data">
            @csrf
            <div class="form-box">
                    ...
                    <div class="col-lg-6 responsive-column d-flex align-items-center">
                        <div class="input-box">
                            <div class="form-group custom-checkbox pt-4">
                                <input type="checkbox" id="yourCityIsNotListed" name="notlited">
                    ...
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="phone" placeholder="+1(1)8547632521">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text"  name="fax"placeholder="+1(1)1147521433">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <span class="la la-envelope-o form-icon"></span>
                                <input class="form-control" type="text" name="inquiry_email" placeholder="Email for customer inquiries">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="website"placeholder="https://www.techydevs.com/">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="instagram" placeholder="https://www.instagram.com/">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="linkedin" placeholder="https://www.linkedin.com/">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="input-box">
                            ...
                            <div class="form-group d-flex align-items-center">
                                <input class="form-control pl-3" type="text" name="min" placeholder="Min">
                                <span class="px-2">to</span>
                                <input class="form-control pl-3" type="text" name="max" placeholder="Max">
                            </div>
                        </div>
                    </div><!-- end col-lg-6 -->
                    <div class="col-lg-6">
                ...
                <div class="form-content contact-form-action">
                    ...
                    <div class="col-lg-12">
                        <div class="file-upload-wrap">
                            <input type="file" name="img" class="multi file-upload-input with-preview" >
